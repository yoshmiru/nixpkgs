{
  ...
  busybox = import <nix/fetchurl.nix> {
    url = "https://intranet.mayflower.de/s/ErP48RpqJXEgHzF/download/busybox";
    sha256 = "sha256-dBSP8+pdGUYV/+WjU4TSiW6R63FtJaHntB1nHWkUXSA=";
    executable = true;
  };
  bootstrapTools = import <nix/fetchurl.nix> {
    url = "https://intranet.mayflower.de/s/MkefjzbLXAWaabJ/download/bootstrap-tools.tar.xz";
    sha256 = "sha256-/9zizyulCjCUC7bRH2JDQc/UkYCOzT2GAxEvoaZ0Yrk=";
  };
}
